...
from DHT_Sensor import read_dht_temperature, DHT_topic
...
clientname = "PoolAlert"+str(r)
AquaAlert_topic = 'pr/home/PoolAlert/iot_project/111'
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.setWindowTitle("Smart Pool Filter Monitor")
...
class MainWindow(QMainWindow):
    ...
    def update_data(self, water_level=None, temperature=None, pH=None):
        ...
        if current_time - self.last_plot_time >= 10:
            self.plot_data()
